// src/lib.rs
/*
 * Core library for HarmonyFoundry
 */
...
#[derive(Debug)]
pub struct HarmonyFoundryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HarmonyFoundryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HarmonyFoundry processing");
    
    let mut processor = HarmonyFoundryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HarmonyFoundryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HarmonyFoundryProcessor::new(false);
